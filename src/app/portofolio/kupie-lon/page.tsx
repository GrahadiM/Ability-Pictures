...
function PortofolioDetail({ params }: { params: { detail: string } }) {
    const thumbnail = "/images/product/kupielon/cover.png";
    const title = "Kupie LON";
    return (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="col-span-1 lg:col-span-2">
                        <div className="flex flex-col gap-4 w-full">
                            <Image
                                src="/images/product/kupielon/1.png"
                                alt={title}
                                width={540}
                                height={320}
                            ...
                            />
                            <Image
                                src="/images/product/kupielon/2.png"
                                alt={title}
                                width={540}
                                height={320}
                                className="w-full h-full object-cover"
                            ...
                            />
                            <Image
                                src="/images/product/kupielon/3.png"
                                alt={title}
                                width={540}
                                height={320}
                                className="w-full h-full object-cover"
                            ...
                            />
                            <Image
                                src="/images/product/kupielon/4.png"
                                alt={title}
                                width={540}
                                height={320}
                                className="w-full h-full object-cover"
                    ...
                    <div className="col-span-1">
                        <div className="sticky top-20 flex flex-col gap-8">
                            ...
                            <Typography
                                ...
                                className="capitalize font-medium text-md"
                            >
                                <span className="capitalize font-bold text-md">Client:</span> Kupie LON <br />
